...
public class ProCityDisEditPopView implements OnTouchListener {
	...
	private HomeObjectBase mHomeObject;
...
//	ArrayList<String> resultList = new ArrayList<String>();
	...
	private void initData() {
		popupView = ((Activity) mContext).getLayoutInflater().inflate(R.layout.provice_city_dis_view, null);
	...
	private void initPopWindow(View view) {
		if (mPopupWindow == null) {
			...
			mPopupWindow.setAnimationStyle(R.style.ProCityDisPopViewAnimation);
	...
	class MyCursorAdapter extends CursorAdapter {
		...
		public View newView(Context context, Cursor cursor, ViewGroup parent) {
			TextView convertView = (TextView) LayoutInflater.from(context).inflate(R.layout.address_grid_item, parent, false);
	...
	public void setHomeObject(HomeObjectBase homeObject) {
		if(homeObject == null) {
	...
	public HomeObjectBase getHomeObject() {
		if(mHomeObject == null) {
			mHomeObject = new HomeObjectBase();
		}
		...
		if (!TextUtils.isEmpty(mHomeObject.mHomeDis)) {
            mHomeObject.initAdminCode(mContext);
		}
